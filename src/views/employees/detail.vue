        ...
        <el-tabs>
          <el-tab-pane label="登录账号设置">
            ...
            >
              ...
              <el-form-item>
                <el-button type="primary" @click="appUser()">更新</el-button>
              </el-form-item>
            </el-form>
          </el-tab-pane>
          <el-tab-pane label="个人详情" class="employees-detail-container">
            <!-- 内容 -->
            ...
            <user-info class="tooltip-pane"></user-info>
          </el-tab-pane>
          <el-tab-pane label="岗位信息" class="employees-detail-container">
            <!-- 内容 -->
            ...
            <job-info class="tooltip-pane"></job-info>
          </el-tab-pane>
        </el-tabs>
      </el-card>
    </div>
...
import { appUserListApi } from '@/api/employee'
